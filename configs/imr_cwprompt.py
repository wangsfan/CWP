...
def get_args_parser(subparsers):
    subparsers.add_argument('--batch-size', default=60, type=int, help='Batch size per device')
    ...
    subparsers.add_argument('--num_prompts_per_task', default=40, type=int, help='max number of prompts to be generated for each task')
    subparsers.add_argument('--variable_num_prompts', default=False, type=bool, help='if variable number of prompts per task are to be used')
    ...
    subparsers.add_argument('--prompt_key_init', default='uniform', type=str)#uniform
