...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--dataset', default='Split-EuroSAT', type=str, help='dataset name')
    ...
    subparsers.add_argument('--num_prompts_per_task', default=2, type=int, help='max number of prompts to be generated for each task')
